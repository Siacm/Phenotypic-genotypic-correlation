...
genotypic_coverage<-read.csv("~/Documents/PhD/Chapter_2/Run_results/abricate_results/100id100cov_mdusamplesinput010319_metadataAll.csv")
...
validation_set_numbers<- read.csv("~/Documents/PhD/Chapter_2/amr_files/resistance_data/Validation_ids.csv")
matched_merged_gp_files<- merge(validation_set_numbers,matched_merged_gp_files, by ="ID",all=FALSE)
