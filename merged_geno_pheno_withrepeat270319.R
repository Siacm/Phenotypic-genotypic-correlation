...
genotypic <- read.csv("~/Documents/PhD/Chapter_2/Run_results/abricate_results/95id100cov_mdusamplesinput040319_metadataAll_simplified.csv")
...
#remove the lab numbers from no_repeat_sensi_done file from genotypic data as they were not done. 
No_repeat_sensi_done <- read.csv("~/Documents/PhD/Chapter_2/amr_files/discordant_numbers/all_discordant/No_repeat_sensi_done.csv", header = FALSE)
genotypic <- genotypic[ ! genotypic$ID %in% No_repeat_sensi_done$V1, ]
...
phenotypic<- read.csv("~/Documents/PhD/Chapter_2/amr_files/resistance_data/updated_phenotypic_amr_27.3.19.csv")

#remove the lab numbers from no_repeat_sensi_done file from phenotypic as they were not done. 
phenotypic <- phenotypic[ ! phenotypic$ID %in% No_repeat_sensi_done$V1, ]
...
#remove the lab numbers from no_repeat_sensi_done file from merged_ariba as they were not done. 
merged_ariba_gyrpar <- merged_ariba_gyrpar[ ! merged_ariba_gyrpar$ID %in% No_repeat_sensi_done$V1, ]
...
#remove the lab numbers from no_repeat_sensi_done file from merged_ariba as they were not done. 
merged_sistr <- merged_sistr[ ! merged_sistr$ID %in% No_repeat_sensi_done$V1, ]

#get QC data for maybe results
genotypic_coverage<-read.csv("~/Documents/PhD/Chapter_2/Run_results/abricate_results/95id100cov_mdusamplesinput040319_metadataAll.csv")
